  ...
  return (
    <section data-aos="fade-up" className="sections">
      ...
      <div data-aos="fade-up" style={{display:'flex', justifyContent:'center', alignItems:'center', marginTop:'3rem'}}>
        ...
        id="github-top-langs"
          align="center"
          src="https://github-readme-stats.vercel.app/api/top-langs/?username=heyvipul&theme=neon&border_radius=2.7"
          alt="Bharat-Shaw"
        />
      </div>
      <div  data-aos="fade-up" style={{display:'flex', justifyContent:'center', gap:'10px', marginTop:'3rem'}} id="github-stat" >
        ...
        id="github-stats-card"
          align="center"
          src="https://github-readme-stats.vercel.app/api?username=heyvipul&theme=neon&border_radius=2.7&show_icons=true"
          alt="Bharat-Shaw"
        />
        <img
        id="github-streak-stats"
          align="center"
          src="https://github-readme-streak-stats.herokuapp.com?user=heyvipul&theme=neon&border_radius=2.7&date_format=M%20j%5B%2C%20Y%5D"
          alt="Bharat-Shaw"
        />
      </div>
    </section>
